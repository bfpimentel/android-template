...
import dev.pimentel.template.domain.usecase.DecreaseCount
import dev.pimentel.template.domain.usecase.DeleteCounters
import dev.pimentel.template.domain.usecase.GetCounters
...
import dev.pimentel.template.presentation.counters.CountersContract
import dev.pimentel.template.presentation.counters.CountersFragmentDirections
import dev.pimentel.template.presentation.counters.CountersViewModel
import dev.pimentel.template.presentation.counters.data.CounterViewData
...
import dev.pimentel.template.presentation.counters.mappers.CountersDeletionMapper
import dev.pimentel.template.presentation.counters.mappers.CountersSharingMapper
